...
public class FindMedicine {
    ...
    @FXML
    private TableColumn<Medicine, String> costColumn;

    @FXML
    private TableColumn<Medicine, String> countColumn;
    ...
    private void setupTable() {
        nameColumn.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().findMedicine()[0]));
        manufacturerColumn.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().findMedicine()[1]));
        expiryDateColumn.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().findMedicine()[2]));
        costColumn.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().findMedicine()[3]));
        countColumn.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().findMedicine()[4]));
    }

    private void loadMedicines() {
        ArrayList<Medicine> medicines = HospitalManagement.getMedicines();
