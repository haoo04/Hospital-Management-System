...
public class LabList {
    ...
    @FXML
    private TableColumn<Lab, String> labColumn;

    @FXML
    private TableColumn<Lab, String> costColumn;
    ...
    private void setupTable() {
        labColumn.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().labList()[0]));
        costColumn.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().labList()[1]));
    }

    private void loadLabs() {
        ArrayList<Lab> labs = HospitalManagement.getLabs();
        ObservableList<Lab> labList = FXCollections.observableArrayList(labs);
